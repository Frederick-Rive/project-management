...
#include <memory>
#include "../../Project-Management/notification.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Notification_t, stringdata0) + ofs), len 
...
const QMetaObject Notification::staticMetaObject = { {
    ...
    qt_meta_stringdata_Notification.offsetsAndSize,
