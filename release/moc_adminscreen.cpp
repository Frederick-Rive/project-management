...
#include <memory>
#include "../../Project-Management/adminscreen.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AdminScreen_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_AdminScreen_t qt_meta_stringdata_AdminScreen = {
    {
QT_MOC_LITERAL(0, 11) // "AdminScreen"
...
const QMetaObject AdminScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_AdminScreen.offsetsAndSize,
    qt_meta_data_AdminScreen,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AdminScreen_t
, QtPrivate::TypeAndForceComplete<AdminScreen, std::true_type>
